...
// need to re visist the following to proper under stand whats happening below: https://tympanus.net/codrops/2020/12/17/recreating-a-dave-whyte-animation-in-react-three-fiber/
...
const Effects: FC = () => {
  ...
  return (
    <effectComposer ref={composer} args={[gl]}>
      ...
      {/* anti-aliasing to smooth out the blur effect */}
      <shaderPass
        attachArray="passes"
        args={[FXAAShader]}
